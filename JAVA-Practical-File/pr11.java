...
//THIS PROGRAM PREPARED BY HARSHIT AJAKIYA 21CE001
...
class pr11 {
    public static void main(String[] args) throws ExecutionException {
        Triplet<String, Integer, Character> p1 = Triplet.of("HARSHT", 1, 'M');
        Triplet<String, Integer, Character> p2 = Triplet.of("EREN", 2, 'A');
        Triplet<String, Integer, Character> p3 = Triplet.of("WALTER", 3, 'M');
